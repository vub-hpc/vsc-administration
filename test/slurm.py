...
class SlurmSyncTestGent(TestCase):
    ...
    def test_parse_slurmm_acct_dump(self):
        ...
        self.assertEqual(set(info), set([
            ...
            SlurmAccount(Account='gent', Descr='gent', Org='ugent', Cluster='banette', ParentName='root', User='', Share='1', GrpJobs='', GrpNodes='', GrpCPUs='', GrpMem='', GrpSubmit='', GrpWall='', GrpCPUMins='', MaxJobs='', MaxNodes='', MaxCPUs='', MaxSubmit='', MaxWall='', MaxCPUMins='', QOS='normal', Def_QOS=''),
            SlurmAccount(Account='vo2', Descr='vo2', Org='ugent', Cluster='banette', ParentName='gent', User='', Share='1', GrpJobs='', GrpNodes='', GrpCPUs='', GrpMem='', GrpSubmit='', GrpWall='', GrpCPUMins='', MaxJobs='', MaxNodes='', MaxCPUs='', MaxSubmit='', MaxWall='', MaxCPUMins='', QOS='normal', Def_QOS=''),
            ...
            SlurmAccount(Account='vo1', Descr='vo1', Org='ugent', Cluster='banette', ParentName='gent', User='', Share='1', GrpJobs='', GrpNodes='', GrpCPUs='', GrpMem='', GrpSubmit='', GrpWall='', GrpCPUMins='', MaxJobs='', MaxNodes='', MaxCPUs='', MaxSubmit='', MaxWall='', MaxCPUMins='', QOS='normal', Def_QOS='')
        ]))
